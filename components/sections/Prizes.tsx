      ...
      <div className="container mx-auto px-4 z-10 text-center relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-8">
          ...
          {[
            ...
            <Card key={event.id} className={`p-10 border-none h-[300px] flex flex-col justify-center items-center relative overflow-hidden transition-all hover:bg-white/5 group bg-[#080812] ${event.flagship ? "col-span-1 md:col-span-2 lg:col-span-1 border-t-2 border-t-[#00f0ff] shadow-[0_0_20px_rgba(0,240,255,0.05)]" : "border-t border-white/5"}`}>
